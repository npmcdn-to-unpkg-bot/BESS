(function($) {
    ...
    app.controller("mapsController", function($routeParams, $http, $scope, $location, $route) {
        ...
        setTimeout(function() {
            $("#clickSPMap").trigger("click");
        }, 2000);

        var icon = {
            url: '/img/A-logo-maps.png', // url
        ...
        mapslogic.clickMapUpdate = function() {
            setTimeout(function() {
                $("#clickEditMap").trigger("click");
            }, 500);
        }
        mapslogic.clickMapCreate = function() {
            setTimeout(function() {
                $("#clickMapCreate").trigger("click");
            }, 500);
        }
